...
let
  ...
  qutebrowserTheme = theme:
    ...
    in
    ''
      # XoxdWM Qutebrowser theme — generated from Emacs theme: ${theme}
  ...
  configEl = ''
    ;;; exwm-vr-config.el --- Generated XoxdWM compatibility configuration  -*- lexical-binding: t; -*-
...
in
{
  options.programs.exwm-vr = {
    enable = lib.mkEnableOption "XoxdWM user configuration";
    ...
    config = lib.mkOption {
      ...
      default = { };
      description = ''
        Attribute set of XoxdWM/legacy EXWM-VR configuration variables.
    ...
    configDir = lib.mkOption {
      ...
      description = "XoxdWM configuration directory. Defaults to the legacy exwm-vr path for compatibility.";
    };
  ...
  config = lib.mkIf cfg.enable (lib.mkMerge [
    # Always: generate config.el, qutebrowser theme, env vars, portal config
    {
      ...
      '';
      xdg.configFile."xdg-desktop-portal/xoxdwm-portals.conf".text = ''
        [preferred]
        default=gtk
        org.freedesktop.impl.portal.ScreenCast=wlr
        org.freedesktop.impl.portal.Screenshot=wlr
