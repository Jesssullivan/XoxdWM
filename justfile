...
remote-proof-surface:
    ...
    @echo "  runner-health.yml      shared tinyland-nix runner and Nix health"
    @echo "  self-hosted-fast.yml   shared fast CI on tinyland-nix"
    @echo "  nix-cache.yml          shared Nix build/cache realizations"
