...
%global package_version %{?_version:%{_version}}%{!?_version:0.5.1}

# The native Rocky release lane is validating installable user-facing RPMs,
# not distro-quality debuginfo/debugsource payloads. Disable autogenerated
# debug subpackages to avoid empty debugsource failures on this mixed Rust/Elisp
# packaging path.
